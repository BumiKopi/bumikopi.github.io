document.addEventListener("alpine:init", () => {
  Alpine.data("products", () => ({
    items: [
      ...
      { id: 2, name: "Arabican Blend", img: "2.jpg", price: 25000 },
  ...
  Alpine.store("cart", {
    ...
    add(newItem) {
      ...
      if (!cartItem) {
        ...
        // Jika barangnya ada, apakah beda atau sama
...
checkoutButton.addEventListener("click", function (e) {
  ...
  window.open("http://wa.me/6285624577466?text=" + encodeURIComponent(message));
});
